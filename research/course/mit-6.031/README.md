...
| Readability & consistency: follow project conventions, whitespace, formatting | 04 Code Review | `ruff format --check` + `biome ci` (frontend) + markdownlint | Format-check tasks in CI; failure blocks merge |
